module.exports = {
  name: 'queimar',
  description: 'queimou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["queimou com força total","queimou de um jeito épico","queimou e o grupo inteiro viu","queimou no estilo gótico 🦇","queimou e ainda sorriu"]
