module.exports = {
  name: 'desafiar',
  description: 'desafiou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["desafiou com força total","desafiou de um jeito épico","desafiou e o grupo inteiro viu","desafiou no estilo gótico 🦇","desafiou e ainda sorriu"]
