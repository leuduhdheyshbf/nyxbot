module.exports = {
  name: 'surpreender',
  description: 'surpreendeu alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    if (!target) return reply('❗ Marque alguém ou responda a mensagem.\nEx: .surpreender @fulano')
    const frases = ["surpreendeu com força total","surpreendeu de um jeito épico","surpreendeu e o grupo inteiro viu","surpreendeu no estilo gótico 🦇","surpreendeu e ainda sorriu"]
