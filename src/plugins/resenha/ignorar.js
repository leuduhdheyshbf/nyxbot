module.exports = {
  name: 'ignorar',
  description: 'ignorou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["ignorou com força total","ignorou de um jeito épico","ignorou e o grupo inteiro viu","ignorou no estilo gótico 🦇","ignorou e ainda sorriu"]
