...
module.exports = {
  name: 'rankpreguica2',
  description: 'Ranking TOP PROCRASTINADORES do grupo',
  category: 'resenha',
  aliases: ["procrastinador"],
  cooldown: 5,
  async execute({ client, from, info, reply, reagir, isGroup, groupMembers, sock, groupMetadata }) {
    ...
    let caption = '🛋️ *TOP PROCRASTINADORES DO GRUPO*\n\n'
    caption += '━━━━━━━━━━━━━━━━━━\n\n'
    items.forEach((it, i) => {
    ...
    try {
      const img = await drawRank({ title: 'TOP PROCRASTINADORES', emoji: '🛋️', items: rankItems })
