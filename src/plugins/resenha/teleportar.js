module.exports = {
  name: 'teleportar',
  description: 'teleportou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    if (!target) return reply('❗ Marque alguém ou responda a mensagem.\nEx: .teleportar @fulano')
    const frases = ["teleportou com força total","teleportou de um jeito épico","teleportou e o grupo inteiro viu","teleportou no estilo gótico 🦇","teleportou e ainda sorriu"]
