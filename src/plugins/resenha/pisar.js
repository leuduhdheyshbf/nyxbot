module.exports = {
  name: 'pisar',
  description: 'pisou em alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["pisou em com força total","pisou em de um jeito épico","pisou em e o grupo inteiro viu","pisou em no estilo gótico 🦇","pisou em e ainda sorriu"]
