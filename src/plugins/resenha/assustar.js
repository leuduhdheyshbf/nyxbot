module.exports = {
  name: 'assustar',
  description: 'assustou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["assustou com força total","assustou de um jeito épico","assustou e o grupo inteiro viu","assustou no estilo gótico 🦇","assustou e ainda sorriu"]
