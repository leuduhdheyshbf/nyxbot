module.exports = {
  name: 'empurrar',
  description: 'empurrou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["empurrou com força total","empurrou de um jeito épico","empurrou e o grupo inteiro viu","empurrou no estilo gótico 🦇","empurrou e ainda sorriu"]
