...
module.exports = {
  name: 'rankinteligente2',
  description: 'Ranking TOP CÉREBRO do grupo',
  category: 'resenha',
  aliases: ["cerebro", "topcerebro"],
  cooldown: 5,
  async execute({ client, from, info, reply, reagir, isGroup, groupMembers, sock, groupMetadata }) {
    ...
    let caption = '🧠 *TOP CÉREBRO DO GRUPO*\n\n'
    caption += '━━━━━━━━━━━━━━━━━━\n\n'
    items.forEach((it, i) => {
    ...
    try {
      const img = await drawRank({ title: 'TOP CÉREBRO', emoji: '🧠', items: rankItems })
