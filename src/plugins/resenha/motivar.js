module.exports = {
  name: 'motivar',
  description: 'motivou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["motivou com força total","motivou de um jeito épico","motivou e o grupo inteiro viu","motivou no estilo gótico 🦇","motivou e ainda sorriu"]
