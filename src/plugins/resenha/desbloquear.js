module.exports = {
  name: 'desbloquear',
  description: 'desbloqueou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    if (!target) return reply('❗ Marque alguém ou responda a mensagem.\nEx: .desbloquear @fulano')
    const frases = ["desbloqueou com força total","desbloqueou de um jeito épico","desbloqueou e o grupo inteiro viu","desbloqueou no estilo gótico 🦇","desbloqueou e ainda sorriu"]
