module.exports = {
  name: 'encostar',
  description: 'encostou em alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["encostou em com força total","encostou em de um jeito épico","encostou em e o grupo inteiro viu","encostou em no estilo gótico 🦇","encostou em e ainda sorriu"]
