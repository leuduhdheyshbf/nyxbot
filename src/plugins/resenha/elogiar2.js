module.exports = {
  name: 'elogiar2',
  description: 'elogiar forte alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["elogiar forte com força total","elogiar forte de um jeito épico","elogiar forte e o grupo inteiro viu","elogiar forte no estilo gótico 🦇","elogiar forte e ainda sorriu"]
