module.exports = {
  name: 'lamber',
  description: 'lambeu alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["lambeu com força total","lambeu de um jeito épico","lambeu e o grupo inteiro viu","lambeu no estilo gótico 🦇","lambeu e ainda sorriu"]
