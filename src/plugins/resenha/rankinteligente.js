...
module.exports = {
  ...
  description: 'Ranking TOP INTELIGENTES do grupo',
  category: 'resenha',
  aliases: ['inteligente', 'topiq', 'iq'],
  cooldown: 5,
  ...
  async execute({ client, from, info, reply, reagir, isGroup, groupMembers, sock, groupMetadata }) {
    ...
    let caption = '🧠 *TOP INTELIGENTES DO GRUPO*\n\n'
    caption += '━━━━━━━━━━━━━━━━━━\n\n'
    items.forEach((it, i) => {
    ...
    try {
      const img = await drawRank({ title: 'TOP INTELIGENTES', emoji: '🧠', items: rankItems })
      ...
      console.error('[rankinteligente]', e.message)
