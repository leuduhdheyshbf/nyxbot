module.exports = {
  name: 'curar',
  description: 'curou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["curou com força total","curou de um jeito épico","curou e o grupo inteiro viu","curou no estilo gótico 🦇","curou e ainda sorriu"]
