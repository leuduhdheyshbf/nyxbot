module.exports = {
  name: 'bloquear',
  description: 'bloqueou alguém (menção/reply)',
  category: 'resenha',
  aliases: [],
  async execute({ client, from, info, args, reply, sender, reagir }) {
    ...
    const frases = ["bloqueou com força total","bloqueou de um jeito épico","bloqueou e o grupo inteiro viu","bloqueou no estilo gótico 🦇","bloqueou e ainda sorriu"]
